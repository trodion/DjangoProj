...
def catalog(request):
    ...
    if 'product_ids' in request.COOKIES:
        ...
        product_count_in_cart=0
    return render(request,'ecom/catalog.html',{'products':products,'product_count_in_cart':product_count_in_cart})
...
def search_view(request):
    ...
    word="Найденные товары:"

    if request.user.is_authenticated:
        return render(request,'ecom/catalog.html',{'products':products,'word':word,'product_count_in_cart':product_count_in_cart})
    return render(request,'ecom/catalog.html',{'products':products,'word':word,'product_count_in_cart':product_count_in_cart})
